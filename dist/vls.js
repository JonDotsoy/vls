...
},{".":2,"lodash.isundefined":6}],2:[function(require,module,exports){
'use strict';
...
function ref(name) {
  var defineValue = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
...
function findEntry(validator) {
  ...
  var returned = void 0;
  var entries = this.ref.entries();

  while (true) {
    var _entries$next = entries.next(),
        done = _entries$next.done,
        values = _entries$next.value;
...
},{"lodash.curry":3,"lodash.isfunction":4,"lodash.isobject":5}],3:[function(require,module,exports){
(function (global){
/**
